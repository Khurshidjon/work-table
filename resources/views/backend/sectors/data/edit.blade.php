            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('data.update', ['data' => $data, 'type' => $type]) }}" method="post" autocomplete="off">
                                @csrf
                                @method('put')
                                <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="indicator_id" id="indicator_id" class="form-control">
                                                            ...
                                                            @foreach($indicators as $indicator)
                                                                <option value="{{ $indicator->id }}" {{ $indicator->id == $data->indicator_id ? 'selected' : '' }}>{{ $indicator->name_uz }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                @elseif($type == 'region')
                                                    <div class="form-group">
                                                        ...
                                                        <select name="region_id" id="regions" class="form-control" required aria-required="true">
                                                            ...
                                                            @foreach($regions as $region)
                                                                <option value="{{ $region->id }}" {{ $region->id == $data->region_id ? 'selected' : '' }}>{{ $region->name_uz }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <select name="district_id" id="districts" class="form-control" required aria-required="true">
                                                            ...
                                                            <option value="{{ $district->id }}" selected>{{ $district->name_uz }}</option>
                                                        </select>
                                                    </div>
                                                @endif
                                                <div class="form-group">
                                                    <label for="districts">Kerakli ustun</label>
                                                    <select name="section_id" class="form-control">
                                                        <option value="">--select section--</option>
                                                        @foreach($sections as $section)
                                                            <option value="{{ $section->id }}" {{ $section->id == $data->section_id ? 'selected' : '' }}>{{ $section->name_uz }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6 mt-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="title" class="form-control" placeholder="Titile" name="title" value="{{ old('title', $data->title) }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="unit_id" id="unit_id" class="form-control">
                                                                ...
                                                                @foreach($units as $unit)
                                                                    <option value="{{ $unit->id }}" {{ $unit->id == $data->unit_id ? 'selected' : '' }}>{{ $unit->name_uz }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
