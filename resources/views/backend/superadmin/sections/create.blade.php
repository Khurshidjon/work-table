                          ...
                          <div class="card">
                              ...
                              <div class="card-body">
                                  ...
                                  <div class="form-group">
                                      <input type="text" class="form-control" placeholder="Colspan" name="colspan" value="{{ old('colspan') }}">
                                  </div>
                                  <div class="form-group">
                                      <input type="text" class="form-control" placeholder="Rowspan" name="rowspan" value="{{ old('rowspan') }}">
                                  </div>
                                  <div class="form-group">
                                      <input type="text" class="form-control" placeholder="Order" name="order" value="{{ old('order') }}">
                                  </div>
                                  <div class="form-group">
                                      <select name="table_id" class="form-control">
                                          <option value="">--select table--</option>
                                          @forelse($tables as $table)
                                              <option value="{{ $table->id }}">{{ $table->name_uz }}</option>
                                          @endforeach
                                      </select>
                                  </div>
                                  <div class="form-group">
