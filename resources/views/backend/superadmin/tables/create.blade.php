                              ...
                              <div class="card-body">
                                  ...
                                  <div class="tab-content">
                                      <div class="tab-pane active" id="profile">
                                          <input type="text" class="form-control" placeholder="Table name uz" name="name_uz" value="{{ old('name_uz') }}">
                                      </div>
                                      <div class="tab-pane" id="messages">
                                          <input type="text" class="form-control" placeholder="Table name ru" name="name_ru" value="{{ old('name_ru') }}">
                                      </div>
                                      <div class="tab-pane" id="settings">
                                          <input type="text" class="form-control" placeholder="Table name en" name="name_en" value="{{ old('name_en') }}">
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-check">
                                      <br>
                                      <label class="form-check-label">
                                          <input class="form-check-input" type="checkbox" name="type" {{ old('type') == 'on'? 'checked':'' }}>
                                          Type (table)
                                          <span class="form-check-sign">
                                            <span class="check"></span>
                                          </span>
